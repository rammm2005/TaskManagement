...
<body class="g-sidenav-show  bg-gray-100" style="height: 100vh !important;">
    ...
    @include('layouts.navbars.auth.magang.sidebar')
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        @include('layouts.navbars.auth.magang.nav')
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js" integrity="sha512-1/qDrzK75jL+4nTVgIaRvD+aFWh5BUpHdx+X5BZhzwwaxGg++9JPrP6+mvqN5wQ0wFUKJx6iU4YfFUmQ3wglHg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
